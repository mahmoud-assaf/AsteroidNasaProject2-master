...
class AsteroidRepository(private val database: AsteroidDatabase) {
  ...
  /*          NasaApi.retrofitService.getAsteroidsAsync(Constants.API_KEY,nextSevenDaysFormattedDates[0],nextSevenDaysFormattedDates[6]).enqueue(object : Callback<String> {
                ...
                override fun onResponse(call: Call<String>, response: Response<String>) {
                    ...
                    if (asteroidString != null) {
                        Log.e("network",asteroidString)
                    }else{
                        Log.e("network","nuuuuul")

                    }
                    val obj = JSONObject(asteroidString)
                    val asteroidList= parseAsteroidsJsonResult(obj)
                    Log.e("asteroidList",""+asteroidList.size)
